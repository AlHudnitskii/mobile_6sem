...
public final class FragmentStatsBinding implements ViewBinding {
  ...
  private FragmentStatsBinding(@NonNull LinearLayout rootView, @NonNull ProgressBar progressBar,
  ...
  public static FragmentStatsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentStatsBinding((LinearLayout) rootView, progressBar, recyclerView, tvEmpty);
    }
