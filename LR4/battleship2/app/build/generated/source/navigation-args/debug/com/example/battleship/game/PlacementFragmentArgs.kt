...
public data class PlacementFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): PlacementFragmentArgs {
      bundle.setClassLoader(PlacementFragmentArgs::class.java.classLoader)
      val __gameId : String?
      ...
      return PlacementFragmentArgs(__gameId, __isPlayer1)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): PlacementFragmentArgs {
      val __gameId : String?
